...
CREATE TABLE `doctor` (
  ...
  PRIMARY KEY (`emp_id`),
  CONSTRAINT `doctor_ibfk_5` FOREIGN KEY (`emp_id`) REFERENCES `employee` (`emp_id`) ON DELETE CASCADE,
...
CREATE TABLE `employee` (
  ...
  PRIMARY KEY (`emp_id`),
  CONSTRAINT `employee_ibfk_6` FOREIGN KEY (`emp_id`) REFERENCES `user_registration` (`user_id`) ON DELETE CASCADE,
...
INSERT INTO `medicines` VALUES ('1',200,'Feverones ',3),('5',2000,'sinus ',1),('9',250,'Cough',2);
...
CREATE TABLE `patient` (
  ...
  CONSTRAINT `patient_ibfk_5` FOREIGN KEY (`patient_id`) REFERENCES `user_registration` (`user_id`) ON DELETE CASCADE,
...
CREATE TABLE `prescription` (
  ...
  KEY `emp_id` (`emp_id`),
  CONSTRAINT `prescription_ibfk_12` FOREIGN KEY (`emp_id`) REFERENCES `employee` (`emp_id`) ON DELETE CASCADE,
  ...
  CONSTRAINT `prescription_ibfk_11` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`patient_id`) ON DELETE CASCADE,
...
INSERT INTO `prescription` VALUES ('100','SandyPat','5','Get cured!','SandyDoc','a:4:{i:0;s:1:\"5\";i:1;s:1:\"1\";i:2;s:1:\"9\";i:3;s:1:\"2\";}'),('112','SandyPat','1','Enter textk;dsd here...','SandyDoc',NULL);
...
INSERT INTO `record` VALUES ('1','SandyPat','aditya_recpt','fever');
...
INSERT INTO `user_registration` VALUES ('aaa','c4ca4238a0b923820dcc509a6f75849b','1'),('aditya','c46335eb267e2e1cde5b017acb4cd799','2n'),('aditya_recpt','202cb962ac59075b964b07152d234b70','2r'),('admin','202cb962ac59075b964b07152d234b70',NULL),('N','c4ca4238a0b923820dcc509a6f75849b','2n'),('Nurse','202cb962ac59075b964b07152d234b70','2n'),('qwerty1','202cb962ac59075b964b07152d234b70','1'),('s','c4ca4238a0b923820dcc509a6f75849b','1'),('SandyDoc','202cb962ac59075b964b07152d234b70','2d'),('SandyPat','202cb962ac59075b964b07152d234b70','2p'),('SandyRecep','202cb962ac59075b964b07152d234b70','2r'),('Sandy_Doctor','202cb962ac59075b964b07152d234b70','1');
...
INSERT INTO `wards` VALUES ('101','','General',2000,20,''),('102','None','General',1000,10,'Nurse'),('111','','General',2000,15,'N'),('90','SandyPat','Special',40,10,'aditya'),('45','','Emergency',456,513,'aditya');
...
-- Dump completed on 2014-11-12 22:52:05
