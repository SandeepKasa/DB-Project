...
$db=new sql_db();
$qi=$db->sql_query("SELECT * FROM record where record_no ='$_GET[id]'");
$reci=$db->sql_fetch_array();
?>
<head>
...
<form name="theForm" action="updaterecord_process.php" method="POST" enctype="multipart/form-data" onsubmit='return expert_Validate(theForm);'>
...
<tr><td><font ><b>Record No</b></font><font color='red'>*</font
></td>
<td><select name="idr">
<?php
$db=new sql_db();
$q=$db->sql_query("SELECT record_no FROM record");
...
font></td>
<td><textarea name="inf" rows="3" columns="50" size=25></textarea></td></tr>
