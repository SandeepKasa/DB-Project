...
$db=new sql_db();
$qi=$db->sql_query("SELECT * FROM patient where patient_id='$_GET[id]'");
$pi=$db->sql_fetch_array();
?>
<head>
...
<form name="theForm" action="update_patiprocess.php" method="POST" enctype="multipart/form-data" onsubmit='return expert_Validate(theForm);'>
...
<td><input name="name"value=" <?php echo "$pi[name]"?>" type="text" size=25></td></tr>

<tr><td width=150><font ><b>Age</b></font><font color='red'> * </font></td>
<td><input name="age" value=" <?php echo "$pi[age]" ?>" type="text"  size=25></td></tr> 
...
$q=$db->sql_query("SELECT user_id FROM user_registration");
...
<td><textarea name="add" rows="3" columns="50" size=25><?php echo $pi['address']?></textarea></td></tr>
...
echo "</select>";
$words = explode("_", $pi['phone']);
?>
</td></tr></p>
<tr><td width=150><font ><b>Mobile phone</b></font><font color='red'> * </font></td>
<td><input name="Mphone" type="text" value="<?php echo "$words[0]"?>" size=25></td></tr>
...
<tr><td><font color><b>Gender</b></font><font color='red'> * </font></td>
 ...
 <td><textarea name="inf" rows="3" columns="50" size=25><?php echo "$pi[info]"?></textarea></td></tr>
