...
$db=new sql_db();
$qi=$db->sql_query("SELECT * FROM employee where emp_id ='$_GET[id]'");
$ei=$db->sql_fetch_array();
?>
<head>
...
<form name="theForm" action="update_empprocess.php" method="POST" enctype="multipart/form-data" onsubmit='return expert_Validate(theForm);'>
...
<td><input name="name" value="<?php echo "$ei[name]"?>" type="text"  size=25></td></tr>

<tr><td width=150><font ><b>Age</b></font><font color='red'> * </font></td>
<td><input name="age" value="<?php echo "$ei[age]"?>" type="text"  size=25></td></tr> 

<tr><td><font ><b>Select Employee Id</b></font><font color='red'>*</font></td>
<td><select name="pat">
<?php 
$db=new sql_db();
...
<td><textarea name="add" rows="3" columns="50" size=25><?php echo $ei['address']?></textarea></td></tr>
...
echo "</select>";
$words = explode("_", $ei['phone']);
?>
</td></tr></p>
<tr><td width=150><font ><b>Mobile phone</b></font><font color='red'> * </font></td>
<td><input name="Mphone" type="text" value="<?php echo "$words[0]"?>"size=25></td>
</tr>
<tr><td width=150><font ><b>Mobile phone 2</b></font><font color='red'></font></td>
<td><input name="Mphone2" type="text" value="<?php echo "$words[1]"?>"size=25></td>
</tr>

<tr><td width=150><font ><b>Salary</b></font><font color='red'> * </font></td>
<td><input name="salary" type="text" value="<?php echo "$ei[salary]"?>"size=25></td></tr>

<tr><td><font color><b>Gender</b></font><font color='red'> * </font></td>
   <td><select name="gender" id="gender"><option value="<?php echo "$ei[sex]"?>" selected>select</option>
  <option value='M'>M</option>
  <option value='F'>F</option> </td> </tr>

 <tr><td width=150><font ><b>Qualification</b></font><font color='red'> * </font></td>
 <td><textarea name="qual" rows="3" columns="50" size=25><?php echo $ei['qualification']?></textarea></td></tr>
