...
<form name="theForm" action="patient_process2.php" method="POST" enctype="multipart/form-data" onsubmit='return expert_Validate(theForm);'>
...
<tr><td><font ><b>Patient Id</b></font><font color='red'>*</font></td>
<td><select name="pat">
<?php 
$db=new sql_db();
